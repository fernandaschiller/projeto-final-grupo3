...
public class BuscaStepDefinitions {
    ...
    public void que_usuario_acessa_pagina_home() {
        ...
        assertTrue(driver.getTitle().contains("Saraiva"));
    }

    @Then("deve exibir caixa de pesquisa")
    public void deve_exibir_caixa_pesquisa() {
        assertTrue(driver.findElement(By.cssSelector("[class^=\"vtex-input-prefix__group\"]")).isDisplayed());
    }
    ...
    @And("usuario digitar {string} na caixa de pesquisa")
    ...
    @And("usuario digitar {string} na caixa de pesquisa mas nao apertar enter")
    ...
    public void deve_ser_possivel_clicar_no_item_sugerido() {
